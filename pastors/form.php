    ...
    <div class="card bg-secondary mb-3" style="width: 34rem;">
      <div class="card-body">
        ...
        <?php if ($pastors['picture']): ?>
              <img class="card-img-top mx-auto d-block" style="height:18rem; width: 18rem; border-radius: 50%;" src="<?php echo $pastors['picture'] ?>" alt="Card image cap">
          <?php endif; ?>
      ...
      <div class="card-body bg-secondary mb-3">
        ...
        <h4 class="card-title ">Details of Next of kin (NoK)</h4></div>
          <?php if ($pastors['picturenk']): ?>
              <img class="card-img-top mx-auto d-block" style="height:18rem; width: 18rem; border-radius: 50%;" src="<?php echo $pastors['picturenk'] ?>" alt="Card image cap">
          <?php endif; ?>
        ...
        <hr>
    <button type="submit" class="btn btn-dark"><a href="viewpastor.php" >Back to pastors</a></button>
      </div>
