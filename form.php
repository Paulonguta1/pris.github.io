...
<div id="container">
<h2 class="card-title" align="center"><b> Pastor's registration form </b></h2>
...
<div class="row text-black bg-secondary mb-3 ">
  <div class="col-sm-6 bg-secondary mb-3">
    <div class="card bg-secondary mb-3" style="width: 34rem;">
      <div class="card-body">
        <h4 class="card-title text-center">Pastor's details</h4>
        <?php if ($pastors['picture']): ?>
              <img class="card-img-top" style="height:28rem; width: 28rem; border-radius: 50%;" src="<?php echo $pastors['picture'] ?>" alt="Card image cap">
          <?php endif; ?>
        ...
        <div class="form-row">
            <div class="form-group col-md-12">
              <label>Gender:</label>
              <select name="gender" value=" <?php echo $gender  ?> "required style="width: 200px;">
  ...
  <div class="col-sm-6 text-black bg-secondary mb-3">
    <div class="card bg-secondary mb-3" style="width: 34rem;">
      <div class="card-body bg-secondary mb-3">
        <h4 class="card-title text-center ">Details of Next of kin (NoK)</h4>
          <?php if ($pastors['picturenk']): ?>
              <img class="card-img-top" style="height:28rem; width: 28rem; border-radius: 50%;" src="<?php echo $pastors['picturenk'] ?>" alt="Card image cap">
          <?php endif; ?>
